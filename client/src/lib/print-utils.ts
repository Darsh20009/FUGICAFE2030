...
export async function printShiftThermal(p: {
  ...
  closedAt?: string;
  reportTitle?: string;
}, bizName = 'فوجي كافيه'): Promise<void> {
...
<body>
  <div class="card">
    <div class="header">
      <div class="company-name">فوجي كافيه</div>
...
const COMPANY_NAME = "فوجي كافيه";
const COMPANY_NAME_EN = "Fuji Cafe";
const COMPANY_CR = "7042488606";
const COMPANY_WEBSITE = "fuji.cafe";
...
@media print{
  ...
  <div style="text-align:center;font-size:11px;color:#aaa;padding:4px 0 6px;">
    <strong style="color:#c8941a;">Fuji Cafe</strong>
  </div>
...
<body>
  <div class="receipt">
    ...
    <div class="footer">
      ...
      <p style="margin-top: 8px;">@FujiCafe</p>
    </div>
  </div>
</body>
</html>
...
<body>
  <div class="receipt">
    ...
    <div class="footer">
      ...
      <p style="font-family: monospace;">@FujiCafe</p>
    </div>
  </div>
