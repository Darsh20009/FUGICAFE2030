...
export function Layout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (user?.role === "admin" && pendingAdminCount > 0) {
      document.title = `(${pendingAdminCount}) لوحة التحكم | فوجي كافيه`;
    } else {
      document.title = "فوجي كافيه | Fuji Cafe";
    }
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                ...
                <div className="flex flex-col h-full" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                  ...
                  <div className="px-4 mt-auto pt-4">
                    ...
                    <div className="grid grid-cols-4 gap-2 mb-4">
                      {[
                        { href: "https://www.instagram.com/fujicafe2030", icon: Instagram, bg: "bg-gradient-to-br from-[#f09433] via-[#dc2743] to-[#bc1888]", label: "IG" },
                        { href: "https://x.com/fujicafe2030", icon: SiX, bg: "bg-black", labelColor: "text-white", label: "X" },
                        { href: "https://www.tiktok.com/@fujicafe2030", icon: SiTiktok, bg: "bg-black", labelColor: "text-white", label: "TK" },
                        { href: "https://www.snapchat.com/add/fujicafe2030", icon: SiSnapchat, bg: "bg-[#FFFC00]", labelColor: "text-black", label: "SC" },
                    ...
                    <div className="border-t border-border pt-4 pb-8 text-center">
                      <p className="text-[10px] text-muted-foreground font-bold">© 2026 فوجي كافيه | Fuji Cafe</p>
                      <p className="text-[9px] text-muted-foreground/50 mt-0.5">fuji.cafe</p>
                    </div>
                  </div>
      ...
      <footer className="border-t border-gray-200 bg-white py-8 sm:py-12 md:py-16 mt-12 sm:mt-16 md:mt-24">
        <div className="container grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 px-4">
          ...
          {/* الدعم والمساعدة */}
          <div>
            <h3 className="font-bold text-sm sm:text-base md:text-lg mb-3 sm:mb-4 md:mb-6 text-[#E8637A]">
              {language === 'ar' ? 'الدعم والمساعدة' : 'Help & Support'}
            </h3>
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-800">
              <li><Link href="/pages/about" className="hover:text-[#E8637A] transition-colors">{language === 'ar' ? 'من نحن' : 'About Us'}</Link></li>
              <li><Link href="/terms" className="hover:text-[#E8637A] transition-colors">{language === 'ar' ? 'الشروط والأحكام' : 'Terms & Conditions'}</Link></li>
              <li><Link href="/privacy" className="hover:text-[#E8637A] transition-colors">{language === 'ar' ? 'سياسة الخصوصية' : 'Privacy Policy'}</Link></li>
              <li><Link href="/pages/loyalty" className="hover:text-[#E8637A] transition-colors">{language === 'ar' ? 'برنامج ولاء العملاء' : 'Loyalty Program'}</Link></li>
              <li><Link href="/shipping-policy" className="hover:text-[#E8637A] transition-colors">{language === 'ar' ? 'سياسة الشحن والتوصيل' : 'Shipping Policy'}</Link></li>
              <li><Link href="/return-policy" className="hover:text-[#E8637A] transition-colors">{language === 'ar' ? 'سياسة الاسترجاع والاستبدال' : 'Return Policy'}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-800">
              <li>
                <Link href="/branches" data-testid="link-footer-branches" className="hover:text-[#E8637A] transition-colors">
        ...
        <div className="container mt-8 sm:mt-12 md:mt-16 pt-6 sm:pt-8 border-t border-gray-200 text-center text-xs sm:text-sm text-gray-700 px-4">
          <div className="flex justify-center flex-wrap gap-2 sm:gap-4 mt-4 sm:mt-8">
            {(() => {
              const fallback = [
                { platform: 'instagram', url: 'https://www.instagram.com/fujicafe2030', isActive: true },
                { platform: 'twitter',   url: 'https://x.com/fujicafe2030', isActive: true },
                { platform: 'snapchat',  url: 'https://www.snapchat.com/add/fujicafe2030', isActive: true },
                { platform: 'tiktok',    url: 'https://www.tiktok.com/@fujicafe2030', isActive: true },
              ];
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8">
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className="text-[9px] sm:text-[10px] text-[#E8637A] font-black group-hover:underline">مركز الأعمال</div>
                </div>
              </a>
            </div>
          </div>
          ...
          {/* Copyright */}
          <div className="mt-4 pt-4 border-t border-gray-200">
            <p className="text-xs sm:text-sm text-gray-700">© 2026 فوجي كافيه | Fuji Cafe. {t('allRightsReserved')}.</p>
            ...
            <p className="mt-3 sm:mt-4 text-[10px] sm:text-xs text-gray-600 flex items-center justify-center gap-1.5 flex-wrap">
              <span>صُنع بـ</span>
              <span className="text-[#E8637A] text-base leading-none animate-pulse" aria-label="حب">♥</span>
              <span>عبر</span>
              <a
