...
const translationsFull = {
  ar: {
    ...
    madeWithLove: "فوجي كافيه | Fuji Cafe",
    signIn: "تسجيل الدخول",
    signOut: "تسجيل الخروج",
    cart: "السلة",
    newCollection: "تشكيلة جديدة ٢٠٢٦",
    heroTitle: "قهوة تروي قصة المكان",
    heroDesc: "نقدم لكم تشكيلة حبوب القهوة المختارة بعناية فائقة من أجود مزارع العالم. جودة استثنائية وتفاصيل تعكس شغفنا بفن القهوة.",
    ...
    brandStoryDesc: "في فوجي كافيه، نؤمن أن القهوة ليست مجرد مشروب، بل هي تجربة حسية كاملة. نحرص على اختيار أجود حبوب القهوة من أفضل مزارع العالم لنقدم لك كوباً لا تنساه.",
    happyCustomers: "عميل سعيد",
    masterCraftsmanship: "تحميص متقن",
    exceptionalQuality: "جودة استثنائية",
    exceptionalQualityDesc: "حبوب مختارة بعناية من أجود المزارع",
    ...
    searchPlaceholder: "ابحث عن نوع قهوتك...",
    ...
    optionsLabel: "الخيار (الحجم / النوع)",
    colorLabel: "اختر النوع",
    sizeLabel: "اختر الحجم",
    quantityLabel: "الكمية",
    addToCart: "إضافة إلى السلة",
    originalProduct: "قهوة أصلية وحصرية",
    ...
    footerTagline: "في فوجي كافيه نؤمن أن كل كوب قهوة يحكي قصة. نختار لكم أجود حبوب القهوة من أرقى مزارع العالم لنمنحكم تجربة قهوة استثنائية تليق بذوقكم الرفيع.",
    ...
    luxuryFragrances: "حبوب قهوة فاخرة",
  ...
  en: {
    ...
    madeWithLove: "Fuji Cafe",
    signIn: "Sign In",
    signOut: "Sign Out",
    cart: "Cart",
    newCollection: "New Collection 2026",
    heroTitle: "Coffee That Tells a Story",
    heroDesc: "Introducing our curated selection of premium coffee beans sourced from the world's finest farms. Exceptional quality and details reflecting our passion for the art of coffee.",
    ...
    brandStoryDesc: "At Fuji Cafe, we believe coffee is more than a drink — it's a complete sensory experience. We carefully select the finest coffee beans from the world's best farms to offer you an unforgettable cup.",
    happyCustomers: "Happy Customers",
    masterCraftsmanship: "Master Roasting",
    exceptionalQuality: "Exceptional Quality",
    exceptionalQualityDesc: "Carefully selected beans from the finest farms",
    ...
    searchPlaceholder: "Search for your coffee...",
    ...
    optionsLabel: "Option (Size / Type)",
    colorLabel: "Select Type",
    sizeLabel: "Select Size",
    quantityLabel: "Quantity",
    addToCart: "Add to Cart",
    originalProduct: "Original & Exclusive Coffee",
    ...
    footerTagline: "At Fuji Cafe, we believe every cup of coffee tells a story. We source the finest coffee beans from the world's most prestigious farms to give you an extraordinary coffee experience that befits your refined taste.",
    ...
    original100: "100% Original Beans",
    ...
    buyNow: "Buy Now",
    payLater: "Pay Later",
    luxuryFragrances: "Premium Coffee Beans",
