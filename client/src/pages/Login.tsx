      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 md:p-10 shadow-xl">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            <a href="https://api.whatsapp.com/send/?phone=966552469643" target="_blank" rel="noreferrer" className="text-[10px] font-bold uppercase tracking-widest text-slate-700 hover:text-[#E8637A] transition-colors">
