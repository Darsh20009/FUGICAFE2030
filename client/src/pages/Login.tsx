    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FFFFFF] p-4 relative overflow-hidden" dir="rtl">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="text-center">
          <Link href="/">
            <img src={logoDarkImg} alt="فوجي كافيه" className="h-20 w-auto mx-auto mb-4 cursor-pointer object-contain" />
          </Link>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 md:p-10 shadow-xl">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            <a href="https://api.whatsapp.com/send/?phone=966551329821" target="_blank" rel="noreferrer" className="text-[10px] font-bold uppercase tracking-widest text-slate-700 hover:text-[#E8637A] transition-colors">
