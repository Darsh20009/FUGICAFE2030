...
const logoDark = "/fuji-logo.png";
const logoWhite = "/fuji-logo.png";
...
export default function Invoice() {
  ...
  const sellerName = zatca?.sellerName || "فوجي كافيه — Fuji Cafe";
    ...
    <div className="bg-white min-h-screen" dir="rtl">
      ...
      <div className="invoice-page max-w-[210mm] mx-auto bg-white shadow-2xl my-6 print:my-0 print:shadow-none overflow-hidden">
        ...
        >
          ...
          <div className="relative flex items-center justify-between gap-6">
            ...
            <div className="text-right flex-1 min-w-0">
              <div className="text-[10px] font-black tracking-[0.4em] uppercase text-[#E8637A] mb-2">
              ...
              <p className="text-[11px] text-white/70 font-bold leading-relaxed">
                قهوة متخصصة فاخرة — جودة استثنائية بمعايير عالمية
              </p>
              {vatNumber && (
                <div className="mt-3 inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-[#E8637A]/30 rounded-md px-3 py-1.5">
                  <span className="text-[9px] font-black tracking-widest text-[#E8637A] uppercase">VAT</span>
            ...
            <div className="shrink-0 flex flex-col items-center gap-2">
              ...
              />
              <div className="text-[8px] font-black tracking-[0.3em] uppercase text-[#E8637A]">fuji.cafe</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 text-center text-xs text-gray-700 font-bold">
          ...
          <p className="opacity-70">للاستفسار: support@fuji.cafe</p>
