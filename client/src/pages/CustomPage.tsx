...
export default function CustomPage() {
  ...
  useEffect(() => {
    if (page) {
      const t = page.seoTitle || (isAr ? page.titleAr : page.titleEn) || "فوجي كافيه";
      document.title = `${t} | فوجي كافيه`;
        ...
        {page.heroImage ? (
          <section className="relative h-[55vh] min-h-[360px] overflow-hidden">
            ...
            <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-6">
              <span className="inline-block text-[10px] font-bold uppercase tracking-[0.4em] text-[#E8637A] mb-3">{isAr ? "فوجي كافيه" : "Rfeef Al Oud"}</span>
