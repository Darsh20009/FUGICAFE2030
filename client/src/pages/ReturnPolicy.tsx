...
const sections = [
  ...
  },
  {
    ...
    content:
      "للبدء بعملية الإرجاع أو الاستبدال، تواصل معنا عبر: واتساب 966552469643+ أو البريد الإلكتروني support@fuji.cafe مع ذكر رقم الطلب وسبب الإرجاع وصورة للمنتج. سيتواصل معك فريقنا خلال ٢٤ ساعة لإتمام الإجراءات.",
  },
];
