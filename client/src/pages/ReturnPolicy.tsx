...
const sections = [
  ...
  },
  {
    ...
    content:
      "للبدء بعملية الإرجاع أو الاستبدال، تواصل معنا عبر: واتساب 966551329821+ أو البريد الإلكتروني support@fuji.cafe مع ذكر رقم الطلب وسبب الإرجاع وصورة للمنتج. سيتواصل معك فريقنا خلال ٢٤ ساعة لإتمام الإجراءات.",
  },
];
        ...
        <div className="container px-4 py-12 sm:py-16 max-w-3xl mx-auto">
          ...
          <div className="mt-10 p-6 bg-[#6B3F2A]/3 border border-[#E8637A]/20 rounded-2xl text-center">
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
              تسري هذه السياسة على جميع مشتريات متجر فوجي كافيه الإلكتروني والفروع. نحتفظ بحق تعديل هذه السياسة في أي وقت.
            </p>
