...
const sections = [
  ...
  },
  {
    ...
    title: "التواصل معنا",
    content:
      "إن كان لديك أي استفسار حول سياسة الخصوصية أو طريقة تعاملنا مع بياناتك، يُرجى التواصل معنا عبر: البريد الإلكتروني support@fuji.cafe أو عبر واتساب على الرقم 966552469643+.",
  },
];
