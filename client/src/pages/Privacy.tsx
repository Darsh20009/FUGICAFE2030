...
const sections = [
  ...
  },
  {
    ...
    title: "التواصل معنا",
    content:
      "إن كان لديك أي استفسار حول سياسة الخصوصية أو طريقة تعاملنا مع بياناتك، يُرجى التواصل معنا عبر: البريد الإلكتروني support@fuji.cafe أو عبر واتساب على الرقم 966551329821+.",
  },
];
        ...
        <div className="container px-4 py-12 sm:py-16 max-w-3xl mx-auto">
          ...
          <div className="mt-10 p-6 bg-[#6B3F2A]/3 border border-[#E8637A]/20 rounded-2xl text-center">
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
              تُطبَّق هذه السياسة على جميع خدمات ومنصات فوجي كافيه الرقمية. آخر تحديث: ٢٠٢٦
            </p>
