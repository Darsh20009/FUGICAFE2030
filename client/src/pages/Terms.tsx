...
const sections = [
  {
    ...
    title: "قبول الشروط",
    content:
      "بزيارتك أو استخدامك لمتجر فوجي كافيه الإلكتروني أو تطبيقه أو أي من خدماته، فإنك تُقر بقراءتك وفهمك وموافقتك على الالتزام بجميع الشروط والأحكام الواردة أدناه. في حال عدم موافقتك على أي من هذه الشروط، يُرجى التوقف عن استخدام خدماتنا.",
  },
  {
    icon: AlertCircle,
    title: "تعديل الشروط",
    content:
      "تحتفظ فوجي كافيه بالحق الكامل في تعديل أو تحديث هذه الشروط والأحكام في أي وقت دون إشعار مسبق. تكون هذه التعديلات سارية المفعول فور نشرها على الموقع. يُرجى مراجعة هذه الصفحة بانتظام للاطلاع على أي تغييرات.",
  },
  {
    icon: Package,
    title: "المنتجات والطلبات",
    content:
      "جميع منتجاتنا من حبوب قهوة ومشروبات متخصصة أصيلة 100%. نحتفظ بحق رفض أي طلب أو إلغائه في حالات التلاعب أو توفر معلومات غير صحيحة. الأسعار المعروضة بالريال السعودي وتشمل ضريبة القيمة المضافة وقد تتغير دون إشعار مسبق. تأكيد الطلب عبر البريد الإلكتروني أو الرسائل النصية لا يُعدّ ضماناً نهائياً بتوفر المنتج.",
  },
  {
    icon: CreditCard,
    title: "الدفع",
  ...
  },
  {
    ...
    content:
      "جميع المحتويات الواردة في هذا الموقع، بما تشمل الشعارات والصور والنصوص والتصاميم، هي ملك حصري لفوجي كافيه محمية بموجب قوانين الملكية الفكرية. يُحظر نسخ أي محتوى أو إعادة توزيعه دون إذن كتابي مسبق.",
  },
];
      ...
      <div className="min-h-screen bg-white" dir="rtl">
        ...
        <div className="relative bg-gradient-to-br from-[#1a1a3e] via-[#6B3F2A] to-[#1a1a3e] text-white overflow-hidden">
          ...
          <div className="container relative px-4 py-16 sm:py-20 md:py-28 text-center">
            ...
            <p className="max-w-xl mx-auto text-sm sm:text-base text-white/70 font-medium leading-relaxed">
              يُرجى قراءة هذه الشروط بعناية قبل استخدام خدمات متجر فوجي كافيه
            </p>
          </div>
        </div>
        ...
        <div className="container px-4 py-12 sm:py-16 max-w-3xl mx-auto">
          ...
          <div className="mt-10 p-6 bg-[#6B3F2A]/3 border border-[#E8637A]/20 rounded-2xl text-center">
            ...
            <p className="text-xs text-[#E8637A] font-bold mt-3 tracking-widest uppercase">فوجي كافيه — Fuji Cafe</p>
          </div>
        </div>
      </div>
    </Layout>
