      ...
      <Card className="rounded-2xl border border-amber-200 bg-amber-50/50">
        <CardContent className="p-5">
          ...
          <ul className="text-xs text-amber-800 space-y-1 list-disc list-inside">
            ...
            <li>البريد المُرسَل من <span className="font-mono font-bold">support@fuji.cafe</span> — أضِفه لجهات الاتصال</li>
            <li>القوالب تحمل تصميم Fuji Cafe الفاخر (RTL + ألوان العلامة)</li>
...
function OutlookSetupGuide() {
  ...
  const ACCOUNT_EMAIL = "support@fuji.cafe";
  const SENDER_DOMAIN = "noreply@fuji.cafe";
        ...
        <CardContent className="px-5 pb-6 pt-0 space-y-5">
          ...
          <div className="p-4 rounded-xl bg-white border border-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              ...
              <InfoRow label="اسم العرض" value="فوجي كافيه — Fuji Cafe" />
          ...
          <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-white border border-emerald-200">
            ...
            <ul className="text-xs text-emerald-900 space-y-2">
              ...
              <li className="flex gap-2">
                <span className="text-emerald-600 font-black mt-0.5">✓</span>
                <span>من Outlook: <span className="font-mono bg-white px-1.5 py-0.5 rounded border border-emerald-200">Settings → Mail → Junk email → Safe senders → Add</span> ثم أدخل النطاق <span className="font-mono">@fuji.cafe</span>.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-emerald-600 font-black mt-0.5">✓</span>
              ...
              <li className="flex gap-2">
                <span className="text-emerald-600 font-black mt-0.5">✓</span>
                <span>أنشئ قاعدة (Rule): <span className="font-mono bg-white px-1.5 py-0.5 rounded border border-emerald-200">Settings → Rules → Add new rule</span> — كل رسالة من <span className="font-mono">@fuji.cafe</span> تُنقل تلقائياً إلى مجلد "طلبات RF" مميّز.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-emerald-600 font-black mt-0.5">✓</span>
