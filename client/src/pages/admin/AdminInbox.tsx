        ...
        <Card className="rounded-2xl border-2 border-dashed border-[#E8637A]/40 bg-gradient-to-br from-[#FFFFFF] to-white">
          <CardContent className="p-10 text-center">
            ...
            <p className="text-sm text-slate-500 max-w-md mx-auto mb-3 leading-relaxed">
              أضف صناديق بريد الموظفين (مثل <span className="font-mono font-bold text-[#E8637A]">sales@fuji.cafe</span>) لقراءة وإرسال الرسائل من داخل لوحة التحكم مباشرة.
            </p>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} placeholder="sales@fuji.cafe" dir="ltr" className="h-10 rounded-lg" data-testid="input-account-email" />
              </div>
              <div>
