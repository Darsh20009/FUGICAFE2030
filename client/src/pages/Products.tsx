...
export default function Products() {
  ...
  return (
    <Layout>
      <SEO
        title="تسوق القهوة المتخصصة — فوجي كافيه Fuji Cafe"
        description="تصفح أكبر مجموعة قهوة متخصصة في السعودية من متجر فوجي كافيه Fuji Cafe — إسبريسو، كابتشينو، قهوة إثيوبية، حبوب قهوة فاخرة. أسعار مناسبة وشحن سريع لجميع مدن السعودية."
        keywords="تسوق قهوة, فوجي كافيه, Fuji Cafe, شراء قهوة اونلاين, أفضل قهوة سعودية, قهوة متخصصة, حبوب قهوة, إسبريسو, كابتشينو, قهوة الرياض, قهوة جدة, قهوة السعودية"
        canonical="/products"
        ogType="website"
      />
