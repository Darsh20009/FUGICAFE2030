...
const sections = [
  {
    ...
    content:
      "حالياً يتوفر الاستلام من فروعنا فقط. بعد إتمام طلبك ودفعه، يمكنك الحضور لأي فرع من فروع فوجي كافيه لاستلام طلبك. يُرجى إحضار رقم الطلب أو رسالة التأكيد عند الاستلام.",
  },
  {
    icon: Bell,
  ...
  },
  {
    ...
    title: "فروع الاستلام",
    content:
      "يمكنك الاستلام من أي فرع من فروع فوجي كافيه المتاحة في المملكة العربية السعودية. لعرض جميع الفروع ومواقعها وأوقات العمل، يُرجى زيارة صفحة الفروع على موقعنا.",
  },
  {
    icon: Package,
    title: "التغليف والجودة",
    content:
      "جميع منتجاتنا تُعبّأ بعناية فائقة في علب فاخرة تعكس هوية فوجي كافيه. يُرجى فحص الطلب عند الاستلام والتأكد من مطابقته للطلب قبل المغادرة. في حال وجود أي ملاحظة، أخبر الموظف فوراً.",
  },
  {
    icon: Phone,
    title: "تواصل معنا",
    content:
      "لأي استفسار حول طلبك أو مواعيد الاستلام، تواصل معنا عبر: واتساب 966551329821+ أو البريد الإلكتروني support@fuji.cafe. فريق خدمة العملاء متاح من السبت إلى الخميس من ٩ صباحاً حتى ١٠ مساءً.",
  },
];
        ...
        <div className="relative bg-gradient-to-br from-[#1a1a3e] via-[#6B3F2A] to-[#1a1a3e] text-white overflow-hidden">
          ...
          <div className="container relative px-4 py-16 sm:py-20 md:py-28 text-center">
            ...
            <p className="max-w-xl mx-auto text-sm sm:text-base text-white/70 font-medium leading-relaxed">
              معلومات حول استلام طلباتك من فروع فوجي كافيه
            </p>
          </div>
        </div>
        ...
        <div className="container px-4 py-12 sm:py-16 max-w-3xl mx-auto">
          ...
          <div className="mt-6 p-6 bg-[#6B3F2A]/3 border border-[#E8637A]/20 rounded-2xl text-center">
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
              تُطبَّق هذه السياسة على جميع طلبات متجر فوجي كافيه الإلكتروني. نحتفظ بحق تعديلها في أي وقت.
            </p>
