...
const sections = [
  ...
  },
  {
    ...
    title: "تواصل معنا",
    content:
      "لأي استفسار حول طلبك أو مواعيد الاستلام، تواصل معنا عبر: واتساب 966552469643+ أو البريد الإلكتروني support@fuji.cafe. فريق خدمة العملاء متاح من السبت إلى الخميس من ٩ صباحاً حتى ١٠ مساءً.",
  },
];
