...
<body>
  <div class="header">
    <div>
      <div class="brand">فوجي كافيه</div>
  ...
  <div class="footer">
    فوجي كافيه &bull; ${isAr ? "شكراً لتعاملكم معنا" : "Thank you for your business"}
  </div>
</body>
</html>`;
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-black text-xl mt-1">فوجي كافيه</p>
                </div>
