                ...
                <div className="container px-4 relative z-10">
                  <Link href={`/products?category=${cat.slug}`}>
                    <div className="relative w-full mb-6 cursor-pointer group overflow-hidden rounded-3xl" style={{ height: "clamp(180px, 28vw, 320px)" }}>
                      {/* Category photo background — uses uploaded category image, falls back to interior photo */}
                      <img
                        src={cat.image || "/fuji-interior-opt.jpg"}
                        alt=""
                        ...
                        loading="lazy"
                        onError={(e) => { (e.target as HTMLImageElement).src = "/fuji-interior-opt.jpg"; }}
                      />
