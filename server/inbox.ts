...
/** Wrap any outgoing email body in the official Fuji Cafe branded HTML template. */
              ...
              <table role="presentation" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:0 auto 12px;">
                <tr>
                  <td align="center" valign="middle" bgcolor="#000000" style="background-color:#000000;border:1px solid #E8637A;border-radius:10px;padding:8px 16px;">
                    <img src="${ASSETS.LOGO_SQUARE}" alt="Fuji Cafe" width="120" height="90" style="display:block;width:120px;height:90px;border:0;outline:none;" />
                  </td>
                </tr>
              </table>
...
const ENC_KEY = crypto.createHash("sha256").update(ENC_KEY_RAW || "fujicafe-dev-only-DO-NOT-USE-IN-PROD").digest();
...
export async function sendFromAccount(accountId: string, params: {
  ...
  // Always wrap outgoing emails in the official Fuji Cafe branded template
